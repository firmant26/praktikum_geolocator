...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String? _distanceToPNB; // ✅ Tambahan variabel jarak

  // ✅ Koordinat tetap: PNB
  final double _targetLatitude = -8.7994;
  final double _targetLongitude = 115.1767;
  ...
  // ✅ Fungsi baru: menghitung jarak ke PNB
  ...
  void _handleGetLocation() async {
    try {
      ...
      _calculateDistanceToPNB(position); // ✅ Tambahkan di sini
    } catch (e) {
      setState(() {
  ...
  void _handleStartTracking() {
    ...
    try {
      _positionStream =
        ...
        _calculateDistanceToPNB(position); // ✅ Tambahan di sini
      });
    } catch (e) {
      setState(() {
        _errorMessage = e.toString();
